...
twitch_miner = TwitchChannelPointsMiner(
    username=input("Insira seu usuário Twitch: "),
    password=getpass.getpass("Insira sua senha: "),
    proxys=input("Insira um proxy (opcional): "),          # If no password will be provided, the script will ask interactively
...
twitch_miner.mine(
    [
        input("Insira suas lives separadas por virgula: ")
