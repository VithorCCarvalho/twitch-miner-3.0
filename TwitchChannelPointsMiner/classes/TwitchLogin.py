...
class TwitchLogin(object):
    ...
    def __init__(self, client_id, username, user_agent, password=None, proxys=None):
    ...
    def send_login_request(self, json_data):
        ...
        response = self.session.post("https://passport.twitch.tv/login", proxies=proxy, json=json_data)
